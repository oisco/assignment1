...
class TheatresControllerTest < ActionController::TestCase
  ...
  test "should create theatre" do
    assert_difference('Theatre.count') do
      post :create, theatre: { capacity: @theatre.capacity, location: @theatre.location, theatreName: @theatre.theatreName }
    end
  ...
  test "should update theatre" do
    patch :update, id: @theatre, theatre: { capacity: @theatre.capacity, location: @theatre.location, theatreName: @theatre.theatreName }
    assert_redirected_to theatre_path(assigns(:theatre))
  end
